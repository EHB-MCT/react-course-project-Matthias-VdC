...
export default function BodyPost(props: any) {
  ...
  const handleOnSubredditClick = useCallback(
    () => navigate("../subreddit/e", { replace: true }),
    [navigate]
  );
    ...
    <>
      <div className="bodyPost-container">
        <div className="bodyPost-header">
          <img onClick={handleOnSubredditClick} src={data.icon} alt="" />
          <div>
            <div>
              <p className="subreddit-text" onClick={handleOnSubredditClick}>
                r/{data.subreddit}
              </p>
            </div>
            <div>
